...
let objectLit = (key1, key2, key3) => `${key1}values1 ${key2}values2 ${key3}values3`


// TODO: Uncomment the following line of code to see the output in the browser console
console.log(objectLit('key1:', 'key2:', 'key3:'));
...
// When I change it to arrow funciton it gives me udefined when I call joe.scope()
// 2. What is "this" when joe.scopeArrow() is invoked?
// When I change it to arrow funciton it gives me udefined when I call joe.scopeArrow()
// 3. Explain why "this" is different when an arrow function is used.
// This inside arrow function doesn't reflect context of the object. Instead it gives the context where the object method is called. refered from https://dmitripavlutin.com/when-not-to-use-arrow-functions-in-javascript/
