...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT I found an error app.js:38 Uncaught ReferenceError: rando is not defined
  // at displayPics (app.js:38)
  // at app.js:136
  console.log(viewed);
...
container.addEventListener('click', handleClick); `click ${handleClick}`,
